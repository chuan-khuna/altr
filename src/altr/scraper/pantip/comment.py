...
def fetch_comments(
    ...
    headers = {'x-requested-with': 'XMLHttpRequest', 'ptauthorize': auth_token, 'User-Agent': user_agent}

    try:
        response = requests.get(COMMENT_API, params=params, headers=headers, timeout=TIMEOUT_SECONDS)
